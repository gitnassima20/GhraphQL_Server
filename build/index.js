...
const resolvers = {
  Query: {
    user: (parent, {
      ...
      return _db__WEBPACK_IMPORTED_MODULE_0__["users"].find(user => user.id === userId);
    },
  ...
  Mutation: {
    ...
    updateUser: (parent, {
      ...
      let updatedUser = _db__WEBPACK_IMPORTED_MODULE_0__["users"].find(user => user.id === id);
    ...
    deleteUser: (parent, {
      ...
      const userIndex = _db__WEBPACK_IMPORTED_MODULE_0__["users"].findIndex(user => user.id === userId);
      if (userIndex === -1) throw new Error('User not found');
      const deletedUser = _db__WEBPACK_IMPORTED_MODULE_0__["users"].splice(userIndex, 1);
